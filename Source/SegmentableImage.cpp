...
void SegmentableImage::stopAllRegions()
{
    for (auto itRegion = regions.begin(); itRegion != regions.end(); ++itRegion)
    {
        ...
        {
            (*itRegion)->setIsPlaying_Click(false); //treat as a click
...
void SegmentableImage::toggleAllRegions()
{
    for (auto itRegion = regions.begin(); itRegion != regions.end(); ++itRegion)
    {
        ...
        {
            (*itRegion)->setIsPlaying_Click(true); //treat as a click
...
void SegmentableImage::stopAllPlayPaths()
{
    for (auto itPath = playPaths.begin(); itPath != playPaths.end(); ++itPath)
    {
        ...
        {
            (*itPath)->setToggleState(false, (*itPath)->getToggleState() != false); //treat as a click
            (*itPath)->stopPlaying();
        }
    }
}
void SegmentableImage::toggleAllPlayPaths()
{
    for (auto itPath = playPaths.begin(); itPath != playPaths.end(); ++itPath)
    {
        ...
        {
            (*itPath)->setToggleState(true, (*itPath)->getToggleState() != true); //treat as a click
            (*itPath)->startPlaying();
        }
    }
}
